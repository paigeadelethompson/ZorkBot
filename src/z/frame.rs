...
impl Frame {
    pub fn new(resume: usize, store: Option<u8>, mut locals: Vec<u16>, arguments: &[u16], initial_stack: Vec<u16>) -> Frame {
    ...
    pub fn stack_pop(&mut self) -> u16 {
        self.stack.pop().unwrap_or(0)  // Return 0 if stack is empty
    }
